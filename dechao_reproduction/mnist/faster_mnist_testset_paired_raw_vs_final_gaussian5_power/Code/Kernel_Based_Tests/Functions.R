...
run_methods_on_resamples <- function(data.X, data.Y, embed.X, embed.Y, resamp.x, resamp.y, B_boot, alpha, noise_sigma, outer_iter, method_names = c("raw_pixel_gaussian5", "layer1_gaussian5", "layer2_gaussian5", "final_embedding_gaussian5", "multilayer_single_gaussian", "multilayer_gaussian15"), n_cores = 1L, ridge_scale = 1e-4){
